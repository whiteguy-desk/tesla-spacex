...
VALUES
  ('00000000-0000-4000-c000-000000000001', 'Silver', 2000.00, 'USD', 'Entry tier membership for emerging private equity and vehicle investors.', ARRAY['Priority Support (48h)', 'Member-only Market Insights', 'Early Access to New Projects'], ARRAY['$2,000 Entry Level', 'Standard Yield Analytics', 'Email Portfolio Digest'], 1, true, 'Deposit $2,000 or maintain active investments to unlock Silver privileges.'),
  ('00000000-0000-4000-c000-000000000002', 'Gold', 5000.00, 'USD', 'Elevated membership tier for active capital allocators with dedicated management.', ARRAY['24/7 Priority Support Line', 'Dedicated Account Manager', 'Reduced Transaction Fees', 'Private Webcast Invitations'], ARRAY['$5,000 Entry Level', 'Real-Time Portfolio Telemetry', 'Priority Vehicle Delivery Allocation'], 2, true, 'Deposit $5,000 or upgrade to unlock Gold privileges.'),
  ('00000000-0000-4000-c000-000000000003', 'Platinum', 10000.00, 'USD', 'Institutional-grade tier offering bespoke portfolio structuring and zero management fees.', ARRAY['1-on-1 Strategy Sessions with Analysts', 'Direct Co-Investment Allocation', 'Zero Strategy Management Fees', 'Exclusive Quarterly Briefings'], ARRAY['$10,000 Entry Level', 'VIP Direct Contact Line', 'Bespoke AI Execution Parameters'], 3, true, 'Deposit $10,000 to achieve Platinum VIP status.')
