...
export const DEFAULT_PROJECTS: Project[] = [
  {
    ...
    description: 'Starship orbital launch tower expansion, liquid methane/LOX tank farm acceleration, and payload integration bay development.',
    location: 'Boca Chica, TX, USA',
    sector: 'Space Infrastructure',
    investment_info: 'Minimum entry allocation: $5,000.',
    features: ['Orbital Pad Acceleration', 'Cryogenic Tank Farm Scale', 'Starship Integration Hub'],
    timeline: 'Horizon: 2025 - 2027',
  },
  {
    ...
    description: 'Deploying utility-scale Megapack energy storage units to stabilize regional renewable grid networks.',
    location: 'South Australia Regional Grid',
    sector: 'Clean Energy & Grid Resilience',
    investment_info: 'Minimum entry allocation: $2,500.',
    features: ['2.5 GWh Storage Capacity', 'Subsecond Frequency Response', 'Renewable Firming Tech'],
    timeline: 'Horizon: 2025 - 2026',
  },
  {
    ...
    description: 'Expanding 350kW+ universal V4 Supercharger stations along key interstate freight and transit arteries.',
    location: 'North America & Europe Expressways',
    sector: 'EV Charging Infrastructure',
    investment_info: 'Minimum entry allocation: $1,000.',
  ...
  },
  {
    ...
    description: 'Second-generation Low Earth Orbit satellite mesh delivering seamless direct-to-cell voice and data backhaul globally.',
    location: 'Low Earth Orbit (Global)',
    sector: 'Satellite Telecom',
    investment_info: 'Minimum entry allocation: $10,000.',
    features: ['Direct-to-Cell Payload', 'Laser Inter-Satellite Links', 'Global Maritime & Aviation Access'],
    timeline: 'Horizon: 2025 - 2028',
  },
  {
    ...
    description: 'Next-generation liquid-cooled GPU megawatt compute facility for frontier artificial intelligence model training.',
  ...
  },
  {
    ...
    description: 'Commercial deployment of unsupervised Full Self-Driving robotaxis in high-density urban ride-hailing networks.',
  ...
  },
  {
    ...
    description: 'Dry electrode coating technology expansion for high-density 4680 cell lines yielding lower costs and higher throughput.',
  ...
  },
  {
    ...
    description: 'Subterranean high-speed EV transit tunnel mesh bypassing surface congestion across resort corridors and airport hubs.',
    location: 'Las Vegas, NV, USA',
    sector: 'Underground Mobility Infrastructure',
    investment_info: 'Minimum entry allocation: $1,500.',
